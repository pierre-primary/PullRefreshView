 ...
 */
public class ExpandRefreshView extends BaseRefreshView {
    View progress;
    View stateImg;
    View loadBox;
    ...
    public ExpandRefreshView(Context context) {
        this(context, null);
    }

    public ExpandRefreshView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ExpandRefreshView(Context context, AttributeSet attrs, int defStyleAttr) {
